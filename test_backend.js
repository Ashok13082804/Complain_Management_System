...
async function run() {
    ...
    await testUrl('http://localhost:5001/api/complaints');
    await testUrl('http://localhost:5001/api/auth/test');
    await testUrl('http://localhost:5001/api/auth/login', 'POST', { email: 'test@test.com', password: 'password' });
